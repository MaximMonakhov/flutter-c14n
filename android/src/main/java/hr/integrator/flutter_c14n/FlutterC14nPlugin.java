...
/** FlutterC14nPlugin */
public class FlutterC14nPlugin implements MethodCallHandler, FlutterPlugin {
  private MethodChannel channel;

  @Override
  public void onAttachedToEngine(FlutterPluginBinding flutterPluginBinding) {
    this.channel = getChannel(flutterPluginBinding.getBinaryMessenger(), this);
  }
  ...
  private static MethodChannel getChannel(BinaryMessenger messager, FlutterC14nPlugin plugin) {
    final MethodChannel channel = new MethodChannel(messager, "flutter_c14n");
